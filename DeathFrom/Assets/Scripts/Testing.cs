...
public class Testing : MonoBehaviour {
    [SerializeField] private MineFieldVisual visual;
    private Grid<HeatMapGridObject> grid;

    private void Start() {
        grid = new Grid<HeatMapGridObject>(4, 4, 1f, Vector3.zero, (Grid<HeatMapGridObject> g, int x, int y) => new HeatMapGridObject(g, x, y));
        ...
        //visual.UpdateGroundVisual(grid.GetWidth(), grid.GetHeight());
